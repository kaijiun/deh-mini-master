...
import com.mmlab.m1.mini.widget.GroupFilterDialog;
    ...
    public void preSetting(View v){
        ...
        if (number != 0 && distance != 0) {
            ...
            if (v.getId() == R.id.button_search_SOI) {
                mType = "SOI";
                action_log = "/API/group/nearbySOI";
                ...
                mType = "AOI";
                action_log = "/API/group/nearbyAOI";
                ...
                mType = "LOI";
                action_log = "/API/group/nearbyLOI";
                ...
                mType = "POI";
                action_log = "/API/group/nearbyPOI";
            ...
            if (v.getId() == R.id.button_search_SOI || v.getId() == R.id.button_search_AOI ||
                ...
                url = api + language + "lat=" + lat + "&lng=" + lng + "&dis=" + distance + "&num=" +
                        number+ tp +fmt + "&group_id=" + g_id+ "&coi_name=" + "test"+"&action=" + action_log + "&devid=" + uuid+ "&useraccount=" + account_for_login+ "&ula=" + curr_lat + "&ulo=" + curr_lng;
            }
            ...
            if (v.getId() == R.id.button_my_POI || v.getId() == R.id.button_my_LOI
                ...
                url = api + "?lat=" + lat + "&lng=" + lng + "&dis=" + distance + "&num=" +
                        number+ "&group_id="+g_id + "&coi_name=" + "test"+ "&action=" + action_log + "&devid=" + uuid+ "&useraccount=" + account_for_login+ "&ula=" + curr_lat + "&ulo=" + curr_lng; /*+ "&did=" + globalVariable.getDeviceID() +
